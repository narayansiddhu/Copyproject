...
public class Eeeone extends AppCompatActivity implements AdapterView.OnItemClickListener
{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eeeone);
        ...
        for (Eeeone_List enum_of_eeeone : Eeeone_List.values()) {
            adapter_of_titles.add(getString(enum_of_eeeone.title));
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Eeeone_List item_of_list = Eeeone_List.values()[position];
        switch (item_of_list) {
            case
                    choice_20:
                Intent intent_siddhu = new Intent(Eeeone.this, siddhu.class);
