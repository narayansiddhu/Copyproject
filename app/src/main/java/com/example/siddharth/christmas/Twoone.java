...
public class Twoone extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Twoone_List enum_of_twoone : Twoone_List.values()) {
            adapter_of_titles.add(getString(enum_of_twoone.title));
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Twoone_List item_of_list = Twoone_List.values()[position];
        switch (item_of_list) {
            case choice_16:
                Intent intent_Csetwoonin = new Intent(Twoone.this, Csetwoonein.class);
                startActivity(intent_Csetwoonin);
                break;
            case choice_17:
                Intent intent_Csetwotwoin = new Intent(Twoone.this, Csetwotwoin.class);
                startActivity(intent_Csetwotwoin);
                break;
