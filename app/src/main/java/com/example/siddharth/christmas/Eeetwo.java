...
public class Eeetwo extends AppCompatActivity implements AdapterView.OnItemClickListener
{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eeetwo);
        ...
        for (Eeetwo_List enum_of_eeetwo : Eeetwo_List.values()) {
            adapter_of_titles.add(getString(enum_of_eeetwo.title));
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Eeetwo_List item_of_list = Eeetwo_List.values()[position];
        switch (item_of_list) {
            case
                    choice_29:
                Intent intent_Eee21 = new Intent(Eeetwo.this, Eee21.class);
                startActivity(intent_Eee21);
                break;
            case
                    choice_30:
                Intent intent_Eee22 = new Intent(Eeetwo.this, Eee22.class);
                startActivity(intent_Eee22);
