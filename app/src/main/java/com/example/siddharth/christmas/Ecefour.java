...
public class Ecefour extends AppCompatActivity implements AdapterView.OnItemClickListener
{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ecefour);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Ecefour_List item_of_list = Ecefour_List.values()[position];
        switch (item_of_list) {
            case
                    choice_26:
                Intent intent_Ece41 = new Intent(Ecefour.this, Ece41.class);
                startActivity(intent_Ece41);
                break;
            case
                    choice_27:
                Intent intent_Ece42 = new Intent(Ecefour.this, Ece42.class);
                startActivity(intent_Ece42);
