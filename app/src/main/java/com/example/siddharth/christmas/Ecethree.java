...
public class Ecethree extends AppCompatActivity implements AdapterView.OnItemClickListener
{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ecethree);
        ...
        for (Ecethree_List enum_of_ecethree : Ecethree_List.values()) {
            adapter_of_titles.add(getString(enum_of_ecethree.title));
        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Ecethree_List item_of_list = Ecethree_List.values()[position];
        switch (item_of_list) {
            case
                    choice_24:
                Intent intent_Ece31 = new Intent(Ecethree.this, Ece31.class);
                startActivity(intent_Ece31);
                break;
            case
                    choice_25:
                Intent intent_Ece32 = new Intent(Ecethree.this, Ece32.class);
                startActivity(intent_Ece32);
